function [trainedModel, validationRMSE] = trainRegressionModelSt11(trainingData)
% [trainedModel, validationRMSE] = trainRegressionModelSt11(trainingData)
...
% set T, enter:
%   [trainedModel, validationRMSE] = trainRegressionModelSt11(T)
%
...
predictorNames = {'$muscle_per []', '$match_per []', 'circ_rad [cm]', 'circ_wid [cm]', 'match_wid [cm]'};
predictors = inputTable(:, predictorNames);
response = inputTable.('dB(St11) []');
...
trainedModel.RequiredVariables = {'$match_per []', '$muscle_per []', 'circ_rad [cm]', 'circ_wid [cm]', 'match_wid [cm]'};
